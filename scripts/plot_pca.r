...
# getwd()
# setwd("/YOUR_PATH_TO_DIRECTORY/research_laboratory_genetics/")
...
population_1000gp <-  read_delim("data/1000GP/1000GP_Phase3.sample", delim = " ")
population_1000gp <- population_1000gp %>% 
  mutate(id_1 = ID)
pca_plot_samples_and_1000gp <- pca_samples_and_1000gp %>% 
  left_join(population_1000gp, by = "id_1") %>%
...
jpeg(
  "results/pca/samples_and_1000GP.jpeg",
  width = 3120, height = 1728, res = 300
)
pca_plot_samples_and_1000gp
dev.off()
